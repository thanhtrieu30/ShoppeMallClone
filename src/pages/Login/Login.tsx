          ...
          <div className='grid grid-cols-1 lg:grid-cols-5 py-12 lg:py-32 lg:pr-10'>
            <div className='lg:col-span-2 lg:col-start-4'>
              <form className='p-5 bg-white shadow-sm rounded'>
                ...
                <button className='mt-3 bg-main w-full p-2 text-white rounded-sm'>Đăng nhập</button>
                <div className='flex p-5 w-full justify-center items-center '>
                  <p className='text-sm mr-2 text-non'>Bạn mới biết đến Shopee?</p>
                  <Link to='/register' className='text-md text-main'>
                    Đăng ký
                  </Link>
                </div>
              </form>
